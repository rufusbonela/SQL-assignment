...
select c.c_name 'Course Name' from tblStudentDetails sd join tblCourseRegistration cr on sd.registerNo = cr.registerNo join tblCourse c on cr.cid = c.cid where sd.name = 'Nisha';